from awpy import Demo # pip install awpy (to read game demo data)
...
dem = Demo("./1-7f613672-b937-4544-a8cc-0f12dee5a151-1-1.dem", verbose=True, ticks=True) # First download file from: https://drive.google.com/file/d/1K8rkcyptsZIhDPGOfR8GscdC5cH-U3pQ/view?usp=drive_link
